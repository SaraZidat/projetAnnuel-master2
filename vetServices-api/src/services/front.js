...
const veterinaireFindOneById = require('../modules/veterinaires/services/findOneById');
const veterinaireCreateOne = require('../modules/veterinaires/services/createOne');
const veterinaireFind = require('../modules/veterinaires/services/find');
...
router.get('/veterinaires', (req, res, next) => {
  veterinaireFind()
    .then((veterinaires) => {
      res.render('veterinaires', { veterinaires });
    })
    .catch((err) => {
      next(err);
    });
...
router.get('/veterinaires/create', (req, res) => {
  res.render('createVeterinaire');
});

router.post('/veterinaires/created', (req, res, next) => {
  const veterinaireToCreate = req.body;

  veterinaireCreateOne(veterinaireToCreate)
    .then((veterinaire) => {
      res.render('veterinaireCreated', { veterinaire });
    })
    .catch((err) => {
      next(err);
    });
...
router.get('/veterinaires/:veterinaireId', (req, res, next) => {
  const {
    veterinaireId,
  } = req.params;

  veterinaireFindOneById(veterinaireId)
    .then((veterinaire) => {
      res.render('veterinaire', { veterinaire });
    })
    .catch((err) => {
      next(err);
    });
