...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["admin-admin-module"], {
  ...
  function srcAppAdminDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function DashboardComponent(cabinetService, cabinetsLoaderService, adminService, router) {
      ...
      _createClass(DashboardComponent, [{
        ...
        */
        ...
        key: "iniCabinetsLoader",
        value: function iniCabinetsLoader() {
        ...
        value: function listCabinets() {
          return this.cabinetService.getListBarInvalide();
        }
      }, {
        key: "isValid",
        value: function isValid(cabinet) {
          //alert('ok');
    ...
    DashboardComponent.ctorParameters = function () {
      return [{
        type: _bar_bar_service__WEBPACK_IMPORTED_MODULE_3__["CabinetService"]
      }, {
